<br>
			...
			<div id="wrapper2">
				<div class="padding_4">
					<br>{PREVIEW}
					Bearbeitungsmodus für den G&auml;stebuchbeitrag von {GB_POSTER}.<br>
					<form action="nickpage.php" method="post" name="npform">
                        ...
                        <br><br>
                        <input type="submit" name="preview" value="Vorschau" onclick="javascript:setAction('preview');">&nbsp; 
                        <input type="submit" name="save" onclick="javascript:setAction('save');" value="Eintragen">
                        <br><br>
					</form>
				</div>
			</div>
