			...
			<div id="wrapper2">
				<div class="padding_4">
					...
					<form action="nickpage.php" method="post" name="npform">
						...
						<textarea name="data" id="data" rows="15" cols="80">{DATA}</textarea>
						<br><br>
                        ...
                        <input type="button" onclick="javascript:buildURLCode();" name="formtags" alt="Link einfügen" title="Link einfügen" value="Link einfügen">&nbsp;
                        <input type="button" onclick="javascript:buildIMGCode();" name="formtags" alt="Bild einfügen" title="Link einfügen" value="Bild einfügen"><br>
                        ...
                        <div id="emobox">
                        	<img src="{EMOS}/grins.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:grins:]")'>&nbsp; 
                        	<img src="{EMOS}/kratz.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:kratz:]")'>&nbsp; 
                        	<img src="{EMOS}/kuss.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:kuss:]")'>&nbsp; 
                        	<img src="{EMOS}/kippe.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:kippe:]")'>&nbsp; 
                        	<img src="{EMOS}/kiss.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:kiss:]")'>&nbsp; 
                        	<img src="{EMOS}/oberlehrer.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:oberlehrer:]")'>&nbsp; 
                        	<img src="{EMOS}/box.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:box:]")'>&nbsp; 
                        	<img src="{EMOS}/think.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:think:]")'>&nbsp; 
                        	<img src="{EMOS}/knuddel.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:knuddel:]")'>&nbsp; 
                        	<img src="{EMOS}/mauer.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:mauer:]")'>&nbsp; 
                        	<img src="{EMOS}/zwinker.gif" alt="Hier klicken um diesen Emo einzuf&uuml;gen..." title="Hier klicken um diesen Emo einzuf&uuml;gen..." onclick='emo("[:zwinker:]")'>
                        </div>
                        <br><br>
